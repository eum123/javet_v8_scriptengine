var 손사_후유장해_장해율조정_신장해_001 = function(IDX,일상지지급율합_오른쪽,일상지지급율합_왼쪽,일하지지급율합_오른쪽,일하지지급율합_왼쪽,장해코드,좌우구분,신장해대상장해율,신장해감액대상비율 ){
    var __TARGET_DATE__;
...
var __RULE_INQUIRY_BASE_DATE__ = __TARGET_DATE__;
    ...
    // Compiler Version 1 , Created : 2023-08-21 18:31:38
    if(IDX == 0){
...
//구구장해감액대상비율 = 0
    ...
    if(IDX == 신장해대상장해율.length - 1  &&  일하지지급율합_왼쪽 > 60){
        신장해감액대상비율 = 신장해감액대상비율 + 일하지지급율합_왼쪽 - 60

    }

    if(IDX == 신장해대상장해율.length - 1  &&  일하지지급율합_오른쪽 > 60){
        신장해감액대상비율 = 신장해감액대상비율 + 일하지지급율합_오른쪽 - 60
