...
var __hrs_logger_object = {executionTime: 0,ruleId:'일반_화재무벽건물동산요율_001',ruleName:'일반_화재무벽건물동산요율',ruleType:'SPREAD',content:__hrs_logger_content,input:__hrs_logger_input,output:__hrs_logger_output,};
...
var __RULE_INQUIRY_BASE_DATE__ = __TARGET_DATE__;
    ...
    && ((물건구분코드 == '2'))){
    _GET_GLOBAL('__hrs_logic_logger').push({ruleId:'일반_화재무벽건물동산요율_001' , row:0});
     __hpasRuleResult = {
'순요율' : 0.185 , '특정물건여부' : "1"
}
    ...
    && ((물건구분코드 == '3'))){
    _GET_GLOBAL('__hrs_logic_logger').push({ruleId:'일반_화재무벽건물동산요율_001' , row:1});
     __hpasRuleResult = {
'순요율' : 0.231 , '특정물건여부' : "1"
}
