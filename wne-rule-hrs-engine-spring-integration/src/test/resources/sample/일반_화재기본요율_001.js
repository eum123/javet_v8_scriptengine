var 일반_화재기본요율_001 = function (건물급수코드,업종코드,물건구분코드,목적물유형코드){
var __TARGET_DATE__; 
var BigDecimal = Java.type('java.math.BigDecimal');
var __hpasRuleResult = { 순요율 : null,특정물건여부 : null }
var 건물급수코드  = 건물급수코드
var 목적물유형코드  = 목적물유형코드
var 물건구분코드  = 물건구분코드
var 순요율 = null
...
// 조건분기 변수 초기화 
var __cond_005 = 물건구분코드 == '01'
// 조건분기 변수 초기화 
var __cond_010 = !( 물건구분코드 == '01' ) && 물건구분코드 == '02'
// 조건분기 변수 초기화 
var __cond_001 = !( 물건구분코드 == '01' ) && !( 물건구분코드 == '02' ) && 물건구분코드 == '03'
// 조건분기 값 할당 
canFlowNext = __cond_005
 if(canFlowNext){_GET_GLOBAL('__hrs_flowNode_logger').push('4b0c7db3-e46a-4398-813e-127f7443002b_011044');
 }
if(canFlowNext){
...
// 조건분기 값 할당 
canFlowNext = __cond_010 && __cond_003
 if(canFlowNext){_GET_GLOBAL('__hrs_flowNode_logger').push('6b926da7-6017-44bd-80bd-400a4162762a_011048');
 }
if(canFlowNext){
...
// join 대상변수 초기화  
var __join_011 = __cond_010 && __cond_003
// 조건분기 값 할당 
canFlowNext = __cond_010 && __cond_000
 if(canFlowNext){_GET_GLOBAL('__hrs_flowNode_logger').push('6b926da7-6017-44bd-80bd-400a4162762a_011048');
 }
if(canFlowNext){
...
// join 대상변수 초기화  
var __join_000 = __cond_010 && __cond_000
// join 후 진행조건 값 할당 
canFlowNext = ( __join_011 ) || ( __join_000 )
 if(canFlowNext){_GET_GLOBAL('__hrs_flowNode_logger').push('22e20b7f-ba27-482c-9974-362d2a131981_011040');
 }
// join 대상변수 초기화  
var __join_002 = (( __join_011 ) || ( __join_000 ))
// 조건분기 변수 초기화 
...
// 조건분기 값 할당 
canFlowNext = __cond_001 && __cond_009
 if(canFlowNext){_GET_GLOBAL('__hrs_flowNode_logger').push('0eaeb465-2849-4108-a696-00cf34a1c7c9_011039');
 }
if(canFlowNext){
...
// join 대상변수 초기화  
var __join_013 = __cond_001 && __cond_009
// 조건분기 값 할당 
canFlowNext = __cond_001 && __cond_004
 if(canFlowNext){_GET_GLOBAL('__hrs_flowNode_logger').push('0eaeb465-2849-4108-a696-00cf34a1c7c9_011039');
 }
if(canFlowNext){
...
// join 대상변수 초기화  
var __join_004 = __cond_001 && __cond_004
// join 후 진행조건 값 할당 
canFlowNext = ( __join_013 ) || ( __join_004 )
 if(canFlowNext){_GET_GLOBAL('__hrs_flowNode_logger').push('b7b18b60-5c98-4d79-9d91-1fe06c8e5bbe_011050');
 }
// join 대상변수 초기화  
var __join_012 = (( __join_013 ) || ( __join_004 ))
 if(( __join_008 ) || ( __join_002 ) || ( __join_012 )){_GET_GLOBAL('__hrs_flowNode_logger').push('4fb6f699-89d4-4ec9-a48e-8efad62ebae9_011045');
 }
