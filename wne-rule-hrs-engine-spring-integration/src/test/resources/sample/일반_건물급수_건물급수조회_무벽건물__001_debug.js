...
var __hrs_logger_object = {executionTime: 0,ruleId:'일반_건물급수_건물급수조회_무벽건물__001',ruleName:'일반_건물급수_건물급수조회(무벽건물)',ruleType:'SPREAD',content:__hrs_logger_content,input:__hrs_logger_input,output:__hrs_logger_output,};
...
var __RULE_INQUIRY_BASE_DATE__ = __TARGET_DATE__;
    ...
    && ((지붕구조구분 == "내화"))
    && ((벽구조구분 == "내화"))){
    _GET_GLOBAL('__hrs_logic_logger').push({ruleId:'일반_건물급수_건물급수조회_무벽건물__001' , row:0});
     __hpasRuleResult = {
'건물급수코드' : "1"
}
    ...
    && ((지붕구조구분 == "내화"))
    && ((벽구조구분 == "불연"))){
    _GET_GLOBAL('__hrs_logic_logger').push({ruleId:'일반_건물급수_건물급수조회_무벽건물__001' , row:1});
     __hpasRuleResult = {
'건물급수코드' : "2"
}
    ...
    && ((지붕구조구분 == "불연"))
    && ((벽구조구분 == "내화"))){
    _GET_GLOBAL('__hrs_logic_logger').push({ruleId:'일반_건물급수_건물급수조회_무벽건물__001' , row:2});
     __hpasRuleResult = {
'건물급수코드' : "2"
}
    ...
    && ((지붕구조구분 == "내화"))
    && ((벽구조구분 == "내화"))){
    _GET_GLOBAL('__hrs_logic_logger').push({ruleId:'일반_건물급수_건물급수조회_무벽건물__001' , row:3});
     __hpasRuleResult = {
'건물급수코드' : "2"
}
    ...
    && ((지붕구조구분 == "불연"))
    && ((벽구조구분 == "내화"))){
    _GET_GLOBAL('__hrs_logic_logger').push({ruleId:'일반_건물급수_건물급수조회_무벽건물__001' , row:4});
     __hpasRuleResult = {
'건물급수코드' : "2"
}
    ...
    && ((지붕구조구분 == "내화"))
    && ((벽구조구분 == "불연"))){
    _GET_GLOBAL('__hrs_logic_logger').push({ruleId:'일반_건물급수_건물급수조회_무벽건물__001' , row:5});
     __hpasRuleResult = {
'건물급수코드' : "2"
}
    ...
    && ((지붕구조구분 == "불연"))
    && ((벽구조구분 == "불연"))){
    _GET_GLOBAL('__hrs_logic_logger').push({ruleId:'일반_건물급수_건물급수조회_무벽건물__001' , row:6});
     __hpasRuleResult = {
'건물급수코드' : "2"
}
    ...
    && ((지붕구조구분 == "불연"))
    && ((벽구조구분 == "불연"))){
    _GET_GLOBAL('__hrs_logic_logger').push({ruleId:'일반_건물급수_건물급수조회_무벽건물__001' , row:7});
     __hpasRuleResult = {
'건물급수코드' : "2"
}
    ...
    && ((지붕구조구분 == '지붕구조구분'))
    && ((벽구조구분 == '벽구조구분'))){
    _GET_GLOBAL('__hrs_logic_logger').push({ruleId:'일반_건물급수_건물급수조회_무벽건물__001' , row:8});
     __hpasRuleResult = {
'건물급수코드' : "4"
}
