var 일반_종합_카네이션보험전환계수조회_001 = function (목적물유형코드,상품코드,룰상품코드){
var __TARGET_DATE__; 
var BigDecimal = Java.type('java.math.BigDecimal');
var __hpasRuleResult = { 상품코드 : null,카네이션보험여부 : null,카네이션보험전환계수 : null }
var 룰상품코드  = 룰상품코드
var 목적물유형코드  = 목적물유형코드
var 상품코드  = 상품코드
var 카네이션보험여부 = null
...
canFlowNext = __cond_004
 if(canFlowNext){_GET_GLOBAL('__hrs_flowNode_logger').push('bd460abe-65ab-46e4-9328-728fff9a0830_017952');
 }
if(canFlowNext){
